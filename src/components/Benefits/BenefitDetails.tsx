...
const BenefitDetails = () => {
    ...
    const specificClub: Club | undefined = clubs?.find(club => club._id === specificBenefit?.clubId);
    ...
    return (
        <div>
            ...
            <div>
                <strong>ID:</strong> {specificBenefit?._id}<br />
                <strong>Description:</strong> {specificBenefit?.description}<br />
                <strong>Supplier Logo:</strong> {specificSupplier?.supplierLogo}<br />
                <strong>Club link:</strong> {specificClub?.clubLink}<br />
