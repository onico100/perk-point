    ...
    <div className={styles.searchContainer}>
      ...
      <div className={styles.clubSelectContainer}>
        <label
          ...
          className={`${styles.clubSelectLabel} ${
      ...
      <label className={styles.dateLabel}>תוקף מ:</label>
      <input
        type="date"
        onChange={(e) =>
          setExpirationStart(e.target.value ? new Date(e.target.value) : null)
        }
        className={styles.dateInput}
      />
      <label className={styles.dateLabel}>עד:</label>
      <input
        type="date"
        onChange={(e) =>
          setExpirationEnd(e.target.value ? new Date(e.target.value) : null)
        }
        className={styles.dateInput}
      />
